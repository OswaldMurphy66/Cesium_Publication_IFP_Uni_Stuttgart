...
class LineFlowMaterialProperty{
    ...
    getValue(time, result){
        ...
        result.percent = Cesium.Property.getValueOrDefault(this._precent, time, 0.1, result.percent);
    ...
    equals(other){
        return(this === other ||
            (other instanceof LineFlowMaterialProperty &&
                ...
                Cesium.Property.equals(this._precent, other._precent)&&
